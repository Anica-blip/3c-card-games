...
- Admin protected by GitHub OAuth login

**Live URLs:**
```
Admin login:    https://anica-blip.github.io/3c-card-games/admin/login.html
Admin panel:    https://anica-blip.github.io/3c-card-games/admin/index.html
